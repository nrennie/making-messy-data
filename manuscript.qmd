...
The documentation and source code for the 'messy' R package can be found at [doi.org/10.32614/CRAN.package.messy](https://doi.org/10.32614/CRAN.package.messy). The source code and data for the examples can also be found on Zenodo at [doi.org/10.5281/zenodo.16995759](https://doi.org/10.5281/zenodo.16995759). The `penguins` data is available through the 'palmerpenguins' R package [@palmerpenguins].
